EQUIVALENCIAS_VARIABLES = {
    ...
    "adlp": [
            "Actividad de la vida diaria (puntuacion)"
        ],
    "adls": [
       "Cambio en actividades de la vida diaria (estado)"
    ],
    "adlsc": [
    ...
    "has_arthritis": [
        "Si el encuestado tiene artritis"
    ],
    ...
    "patient_type": [
        "Tipo de paciente (ambulatorio u hospitalizado)"
    ],
    "date_died": [
        "Fecha de defuncion"
    ],
